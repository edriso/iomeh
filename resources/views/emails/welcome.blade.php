...
@section('content')
    ...
    <div class="content">
        Welcome to <strong>IOMeH - I Owe Me Health</strong>! You've just joined a global health community where <em>consistency beats intensity</em>. Your health journey starts now!
    </div>
